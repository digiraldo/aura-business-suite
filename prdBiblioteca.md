...
## 2. Contexto de Integración con Sistema de Categorías Compartidas (v1.2+)

### 2.0 Integración con Categorías Financieras

Desde v1.2 de Finanzas, el módulo Biblioteca puede vincular **adquisición de libros** automáticamente con categorías financieras compartidas:

**Flujo de configuración:**
1. Admin en **Finanzas → Categorías** crea "Adquisición de Libros" o "Material de Biblioteca" con type `expense`
2. Marca ☑ **Biblioteca** en "Integración con Módulos"
3. Guarda → `integration_modules: ["library"]`
4. En **Biblioteca → Configuración**, selecciona "Adquisición de Libros" como categoría por defecto
5. Activa "Crear transacciones de gasto al registrar adquisiciones"

**Ventajas:**
- Dashboard Financiero unifica todos los gastos de biblioteca
- Un solo lugar para categorizar gastos bibliográficos (vs. dispersar entre varias)
- Reporte financiero muestra tendencia de gasto en libros por período
